(function() {
    ...
    document.getElementById("mybtn1").onclick = function() {
        ...
        if (dayPeriod >= 0 & Tprice > 0) {
            ...
            document.getElementById("result").innerText = String(dayPeriod+1)+"日間";
            document.getElementById("Tprice").innerText = replaceFormatNumber(Math.round(Tprice/7*(dayPeriod+1)))+"円";
        } else {
